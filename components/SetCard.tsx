...
const SetCard = ({ abbreviation, description, icon, name, releaseDate, tags, type }: Set) => {
  ...
  return (
    <div className="grid grid-cols-8 relative bg-gradient-to-r from-gray-800 via-gray-700 to-gray-800 rounded-lg border border-gray-600 overflow-scroll max-w-full p-4 mb-4 max-h-[150px]">
